...
constexpr xpcc::MemoryTraits traits = SCALE >= 4 ? xpcc::MemoryFastData : xpcc::MemoryExternal;
...
void game_of_life()
{
	// for raw performance we draw to our own buffer without xpcc::ui::GraphicDisplay!
	displayBuffer = new (xpcc::MemoryExternal) uint16_t[800*480];
