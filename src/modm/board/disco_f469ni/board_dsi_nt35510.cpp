...
board_initialize_display(uint8_t ColorCoding)
{
	...
	constexpr uint32_t VSA = 120;
	constexpr uint32_t VBP = 150;
	constexpr uint32_t VFP = 150;
	constexpr uint32_t HSA = 5;
	constexpr uint32_t HBP = 34;
	constexpr uint32_t HFP = 34;
	...
	constexpr float ClockRatio =
		62500.f / 27429.0f / 2;  // Need a div by two here to align the images, unsure why
