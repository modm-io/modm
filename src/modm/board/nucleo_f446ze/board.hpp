...
struct SystemClock
{
	...
	{
		.M = 4,  //   8 MHz /  4 =   2 MHz
		.N = 96, //   2 MHz * 96 = 192 MHz
		.Q = 2,  // 192 MHz /  2 =  96 MHz
		.P = 4,  // 192 MHz /  4 =  48 MHz = F_usb
	};
	static constexpr uint32_t PllP = Hse / pll.M * pll.N / pll.P;
	static constexpr uint32_t PllSaiP = Hse / pllSai.M * pllSai.N / pllSai.P;
	...
	enable()
	{
		...
		Rcc::setClk48Source(Rcc::Clk48Source::PllSaiP);
