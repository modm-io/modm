...
#ifndef MODM_LPC11_SPI_0_HPP
#define MODM_LPC11_SPI_0_HPP
...
namespace modm
{
	namespace platform
	{
		 ...
		 *
		 */
		class SpiMaster0 : public modm::SpiMaster
		{
		public:
			...
			static void
			configurePins(
					MappingSck mapping = modm::platform::SpiMaster0::MappingSck::PIO0_6,
					bool useSsel = false);
