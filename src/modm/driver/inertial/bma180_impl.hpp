...
modm::Bma180<I2cMaster>::Bma180(uint8_t* data, uint8_t address)
...
template < typename I2cMaster >
bool
modm::Bma180<I2cMaster>::configure(bma180::Range range, bma180::Bandwidth bandwidth, bma180::ModeConfig mode, bool interrupt)
{
...
template < typename I2cMaster >
void
modm::Bma180<I2cMaster>::readAccelerometer()
{
...
template < typename I2cMaster >
bool
modm::Bma180<I2cMaster>::isNewDataAvailable()
{
...
template < typename I2cMaster >
void
modm::Bma180<I2cMaster>::update()
{
	if (status & READ_ACCELEROMETER_PENDING)
	{
		buffer[0] = bma180::REGISTER_DATA_X0;
		if (I2cDevice<I2cMaster>::writeRead(buffer, 1, data, 7)) {
			status &= ~READ_ACCELEROMETER_PENDING;
		}
	}
}
...
template < typename I2cMaster >
bool
modm::Bma180<I2cMaster>::writeMaskedRegister(bma180::Register reg, uint8_t mask, uint8_t value)
{
	readRegister(reg);
...
template < typename I2cMaster >
bool
modm::Bma180<I2cMaster>::writeRegister(bma180::Register reg, uint8_t value)
{
	buffer[0] = reg;
	buffer[1] = value;
...
template < typename I2cMaster >
uint8_t
modm::Bma180<I2cMaster>::readRegister(bma180::Register reg)
{
	buffer[0] = reg;
