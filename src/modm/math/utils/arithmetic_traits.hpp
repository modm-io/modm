...
template<typename T>
using SignedType [[deprecated("use std::make_signed_t")]] = typename detail::MakeSigned<T>::type; // DEPRECATED: 2027q4

template<typename T>
using UnsignedType [[deprecated("use std::make_unsigned_t")]] = typename detail::MakeUnsigned<T>::type; // DEPRECATED: 2027q4
 ...
 */
template<typename T>
struct [[deprecated("use std::numeric_limits instead")]] ArithmeticTraits // DEPRECATED: 2027q4
{
