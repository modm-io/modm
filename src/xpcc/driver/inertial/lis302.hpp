...
/**
 * LIS302DL I2C Transport Layer.
 *
 * This class manages communication with the accelerometer via the I2C bus.
 *
 * To enable I2C mode in the LIS302, the CS pin must be tied high.
...
class Lis302I2cTransport : public xpcc::I2cDevice< I2cMaster >, protected xpcc::co::NestedCoroutine<1>
{
public:
	Lis302I2cTransport(uint8_t address);
...
class Lis302SpiTransport : public xpcc::SpiDevice< SpiMaster >, protected xpcc::co::NestedCoroutine<1>
{
public:
	Lis302SpiTransport(uint8_t /*address*/);
