...
xpcc::Ltc2984<SpiMaster, Cs>::isBusy()
{
	RF_BEGIN();
...
template < class SpiMaster, class Cs >
xpcc::ResumableResult<void>
xpcc::Ltc2984<SpiMaster, Cs>::configureChannel(ltc2984::Channel channel, uint32_t config)
{
...
template < class SpiMaster, class Cs >
xpcc::ResumableResult<void>
xpcc::Ltc2984<SpiMaster, Cs>::initiateSingleMeasurement(ltc2984::Channel channel)
{
...
template < class SpiMaster, class Cs >
xpcc::ResumableResult<void>
xpcc::Ltc2984<SpiMaster, Cs>::initiateMeasurements()
{
...
template < class SpiMaster, class Cs >
void
xpcc::Ltc2984<SpiMaster, Cs>::enableChannel(ltc2984::Configuration::MuxChannel channel)
{
...
template < class SpiMaster, class Cs >
void
xpcc::Ltc2984<SpiMaster, Cs>::disableChannel(ltc2984::Configuration::MuxChannel channel)
{
	enabledChannels &= ~channel;
}
...
template < class SpiMaster, class Cs >
xpcc::ResumableResult<void>
xpcc::Ltc2984<SpiMaster, Cs>::setChannels()
{
...
template < class SpiMaster, class Cs >
xpcc::ResumableResult<void>
xpcc::Ltc2984<SpiMaster, Cs>::enterSleepMode()
{
...
template < class SpiMaster, class Cs >
xpcc::ResumableResult<void>
xpcc::Ltc2984<SpiMaster, Cs>::readChannel(ltc2984::Channel channel, ltc2984::Data& value)
{
...
template < class SpiMaster, class Cs >
xpcc::ResumableResult<void>
xpcc::Ltc2984<SpiMaster, Cs>::writeData(Register address, uint8_t* data, size_t length)
{
	RF_BEGIN();
...
template < class SpiMaster, class Cs >
xpcc::ResumableResult<void>
xpcc::Ltc2984<SpiMaster, Cs>::writeData(Register address, CommandStatus command)
{
...
template < class SpiMaster, class Cs >
xpcc::ResumableResult<void>
xpcc::Ltc2984<SpiMaster, Cs>::readFourBytes(Register address, uint8_t* data)
{
	RF_BEGIN();
...
template < class SpiMaster, class Cs >
xpcc::ResumableResult<void>
xpcc::Ltc2984<SpiMaster, Cs>::readByte(Register address, uint8_t& command)
{
	RF_BEGIN();
